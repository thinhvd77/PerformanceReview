...
export default function QuarterPlanImportTab() {
    ...
    const handleUpload = async () => {
        ...
        try {
            const response = await api.post("/quarter-plans/import", formData, {
                headers: {
            ...
            if (errors && errors.length > 0) {
                ...
                message.success(`Import thành công ${saved} kế hoạch quý`);
            }
    ...
    return (
        <div style={{ padding: "24px" }}>
            <Card>
                ...
                >
                    <div>
                        <Title level={4}>Import Kế Hoạch Quý từ Excel</Title>
                        <Text type="secondary">
                            File Excel cần có cấu trúc các cột như sau:
                        </Text>
                        <ul>
                            <li>
                                <Text strong>Cột A:</Text> Mã CBNV (ví dụ:
                                123456)
                            </li>
                            <li>
                                <Text strong>Cột B:</Text> Quý (1, 2, 3, hoặc 4)
                            </li>
                            <li>
                                <Text strong>Cột C:</Text> Năm (ví dụ: 2025)
                            </li>
                            <li>
                                <Text strong>Cột D:</Text> Tăng trưởng nguồn vốn
                            </li>
                            <li>
                                <Text strong>Cột E:</Text> Tăng trưởng dư nợ
                            </li>
                            <li>
                                <Text strong>Cột F:</Text> Nợ nhóm 2
                            </li>
                            <li>
                                <Text strong>Cột G:</Text> Nợ xấu
                            </li>
                            <li>
                                <Text strong>Cột H:</Text> Thu dịch vụ
                            </li>
                            <li>
                                <Text strong>Cột I:</Text> Thu hồi nợ đã XLRR
                            </li>
                            <li>
                                <Text strong>Cột J:</Text> Tiếp thị tín dụng
                            </li>
                        </ul>
                        <Alert
                            message="Lưu ý"
